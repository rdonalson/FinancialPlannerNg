...
{
    public partial class UpdateProcedure2SpCreateLedgerReadout : Migration
    {
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.Sql(@"	
USE [FinancialPlannerNg]
GO
/****** Object:  StoredProcedure [ItemDetail].[spCreateLedgerReadout]    Script Date: 8/21/2021 9:16:15 AM ******/
SET ANSI_NULLS ON
GO
...
--===========================================================================================*/
ALTER PROCEDURE [ItemDetail].[spCreateLedgerReadout] (
	@TimeFrameBegin DATE, 
	@TimeFrameEnd DATE,
...
BEGIN
	...
	/* If Initial Amount doesn't exist, then create one with a default value of zero */
	IF (@InitialAmount IS NULL) BEGIN
		/* Diagnostic */
		--PRINT '@InitialAmount: IS NULL'
		INSERT [ItemDetail].[InitialAmount] (
			[UserId], 
			[Amount], 
			[BeginDate]
		) 
...
GO      
		...
		{
			migrationBuilder.Sql(@"	
/****** Object:  StoredProcedure [ItemDetail].[spCreateLedgerReadout]    Script Date: 8/21/2021 9:21:00 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

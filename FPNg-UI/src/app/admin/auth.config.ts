...
export const DiscoveryDocumentConfig = {
  url: 'https://dssorg.b2clogin.com/dssorg.onmicrosoft.com/v2.0/.well-known/openid-configuration?p=b2c_1_susi'
};
...
export const authConfig: AuthConfig = {
  ...
  issuer: 'https://dssorg.b2clogin.com/9c639876-c038-4ae3-a1d8-3f9d0b770e89/v2.0/',
  strictDiscoveryDocumentValidation: false,

  tokenEndpoint: 'https://dssorg.b2clogin.com/dssorg.onmicrosoft.com/oauth2/v2.0/token?p=b2c_1_susi',

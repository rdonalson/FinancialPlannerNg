...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            ...
            authority: 'https://dssorg.b2clogin.com/dssorg.onmicrosoft.com/b2c_1_susi'
        },
        resetPassword: {
            // authority: 'https://fabrikamb2c.b2clogin.com/fabrikamb2c.onmicrosoft.com/b2c_1_reset'
            authority: 'https://dssorg.b2clogin.com/dssorg.onmicrosoft.com/b2c_1_reset'
        },
        editProfile: {
            // authority: 'https://fabrikamb2c.b2clogin.com/fabrikamb2c.onmicrosoft.com/b2c_1_edit_profile'
            authority: 'https://dssorg.b2clogin.com/dssorg.onmicrosoft.com/b2c_1_edit_profile'
        }
    }
};
// #endregion
...
export const apiConfig: {b2cScopes: string[]; webApi: string} = {
    ...
    webApi: 'https://localhost:44324/api/values'
};
// #endregion
...
export const msalConfig: Configuration = {
    auth: {
        ...
        clientId: 'c5cb0a78-8258-48cf-8447-1fca95d67092',
        authority: b2cPolicies.authorities.signUpSignIn.authority,
        redirectUri: 'http://localhost:1000/',
        postLogoutRedirectUri: 'http://localhost:1000/',
